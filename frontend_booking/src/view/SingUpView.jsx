...
const SingUpView= ()=>{
    return(
        <main className="h-screen md:py-10 font-inter flex items-center justify-center relative bg-[url('./img/formback.jpg')] bg-no-repeat bg-center bg-cover max-w-[1920px]">
