...
const UserDescription = ({ className, ...props }) => {
  ...
  return (
    <article
      className={` flex flex-col pt-4 sm:p-4 md:p-8 md:border-r sm:border-b md:border-b-0 border-light-gray sm:flex-row md:flex-col sm:items-center ${className}`}
    >
      <div className=" flex flex-col items-center ">
        <div
          className={`bg-[url('./img/formback.jpg')] bg-center bg-cover bg-no-repeat min-w-[180px] min-h-[180px] rounded-[100%] border border-dark-gray 2xl:w-96 2xl:h-[23rem] xl:w-80 xl:h-[19rem] lg:w-64 lg:h-60 sm:w-60 sm:h-56`}
        ></div>
      </div>
