            ...
            <article className="flex flex-col sm:flex-row gap-6 items-start md:items-center justify-around bg-mustard-yellow text-dark-gray p-8 font-inter">
                <div className=" flex flex-col lg:flex-row gap-6 lg:gap-14 sm:w-1/2 lg:w-auto">
                    <div className="flex flex-col items-center justify-center">
                        <h3 className="font-bebas tracking-wide text-2xl md:text-4xl py-1">Soporte online</h3>
                            <ul className="flex flex-row gap-3 md:gap-8">
                                <li><a target="_blank" href={"https://api.whatsapp.com/message/USWJBQ2THPYVN1?autoload=1&app_absent=0"}>
                                    <WhatsApp style={{fontSize: "38px"}}/>
                                </a></li>
                                <li><a target="_blank" href={"mailto:netpoint.tenis@gmail.com"}>
                                    <Mail style={{fontSize: "38px"}}/>
                                </a></li>
                            </ul>
                    </div>
                    <div className="flex flex-col items-center justify-center">
                        <h3 className="font-bebas tracking-wide text-2xl md:text-4xl py-1">Redes sociales</h3>
                        <ul className="flex flex-row gap-3 md:gap-8">
                            <li><a target="_blank" href={"https://www.facebook.com/netpoint.tenis/?locale=es_LA"}>
                                <FacebookRoundedIcon style={{fontSize: "38px"}}/>
                            </a></li>
                            <li><a target="_blank" href={"https://www.instagram.com/netpointteniselsalvador/"}>
